...
public class Avoidant : Agent
{

    [SerializeField]
    float boundsWeight = 1f, obstacleWeight = 1f, separateWeight = 1f, fleeWeight = 1f, wanderWeight = 1f, wanderRadius = 1f;
    ...
    protected override Vector3 CalculateSteeringForces(){
        ...
        Vector3 fleeForce = FleeSchooling();
        totalForce += fleeForce * fleeWeight;
